...
from jobs.transformandplacement import PlacementDetectionException
...
def get_placement_lateral_hip(data, window_start, window_end, session_id=''):
    ...
    try:
        ...
        if abs(side_0 - side_2) == 1:# or (side_2 + side_0) <= 2:
            _logger.info("Placement detection weak for session_id="+session_id)
