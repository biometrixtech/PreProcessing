...
@xray_recorder.capture('app.jobs.sessionprocess.rate_of_force_absorption.detect_rate_of_force_absorption')
...
@xray_recorder.capture('app.jobs.sessionprocess.rate_of_force_absorption._det_lf_rf_rofa')
