...
column_scoring_out = ['obs_index', 'time_stamp', 'epoch_time', 'ms_elapsed', 'session_duration',
                      ...
                      'grf', 'grf_lf', 'grf_rf', 'const_grf', 'dest_grf', 'destr_multiplier', 'session_grf_elapsed',
                      'symmetry', 'symmetry_l', 'symmetry_r', 'hip_symmetry', 'hip_symmetry_l', 'hip_symmetry_r',
                      ...
                      'contra_hip_drop_lf', 'contra_hip_drop_rf', 'ankle_rot_lf', 'ankle_rot_rf', 'foot_position_lf',
                      'foot_position_rf',
                      'land_pattern_lf', 'land_pattern_rf', 'land_time',
                      'rate_force_absorption_lf', 'rate_force_absorption_rf', 'rate_force_production_lf',
                      'rate_force_production_rf', 'total_accel',
