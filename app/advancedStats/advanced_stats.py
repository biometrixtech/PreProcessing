...
import app.advancedStats.summary_analysis as summary_analysis
...
def script_handler(input_data):
    ...
    try:
        ...
        mc_sl_list, mc_dl_list = advancedStats.logic.complexity_matrix_logic.get_complexity_matrices(user_id,
                                                                                                     event_date)
