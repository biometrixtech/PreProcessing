                ...
                if len(ub) > 0:
                    ...
                    for n in range(0, unit_bock_count):
                        ...
                        if ub_rec.total_accel_avg < 45:
                            ...
                            intensity_bands.low_gct_left += self.get_gct_from_steps(lf_steps, accumulated_grf_LF, "Left",
                                                                               active_block, n, session_position,
                                                                               session_time_start_object)
                            intensity_bands.low_gct_right += self.get_gct_from_steps(rf_steps, accumulated_grf_LF, "Right",
                                                                                active_block, n, session_position,
                                                                                session_time_start_object)
                            intensity_bands.low_average_accel_lf += self.get_avg_from_steps(lf_steps, "total_accel_avg", accumulated_grf_LF, "Left",
                                                                               active_block, n, session_position,
                                                                               session_time_start_object)
                            intensity_bands.low_average_accel_rf += self.get_avg_from_steps(rf_steps, "total_accel_avg", accumulated_grf_LF, "Right",
                                                                                active_block, n, session_position,
                                                                                session_time_start_object)
                            intensity_bands.low_average_GRF_lf += self.get_avg_from_steps(lf_steps, "total_grf_avg", accumulated_grf_LF, "Left",
                                                                               active_block, n, session_position,
                                                                               session_time_start_object)
                            intensity_bands.low_average_GRF_rf += self.get_avg_from_steps(rf_steps, "total_grf_avg", accumulated_grf_LF, "Right",
                                                                                active_block, n, session_position,
                                                                                session_time_start_object)
                            ...
                            intensity_bands.moderate_gct_left += self.get_gct_from_steps(lf_steps, accumulated_grf_LF, "Left",
                                                                               active_block, n, session_position,
                                                                               session_time_start_object)
                            intensity_bands.moderate_gct_right += self.get_gct_from_steps(rf_steps, accumulated_grf_LF, "Right",
                                                                                active_block, n, session_position,
                                                                                session_time_start_object)
                            intensity_bands.moderate_average_accel_lf += self.get_avg_from_steps(lf_steps, "total_accel_avg", accumulated_grf_LF, "Left",
                                                                               active_block, n, session_position,
                                                                               session_time_start_object)
                            intensity_bands.moderate_average_accel_rf += self.get_avg_from_steps(rf_steps, "total_accel_avg", accumulated_grf_LF, "Right",
                                                                                active_block, n, session_position,
                                                                                session_time_start_object)
                            intensity_bands.moderate_average_GRF_lf += self.get_avg_from_steps(lf_steps, "total_grf_avg", accumulated_grf_LF, "Left",
                                                                               active_block, n, session_position,
                                                                               session_time_start_object)
                            intensity_bands.moderate_average_GRF_rf += self.get_avg_from_steps(rf_steps, "total_grf_avg", accumulated_grf_LF, "Right",
                                                                                active_block, n, session_position,
                                                                                session_time_start_object)
                            ...
                            intensity_bands.high_gct_left += self.get_gct_from_steps(lf_steps, accumulated_grf_LF, "Left",
                                                                               active_block, n, session_position,
                                                                               session_time_start_object)
                            intensity_bands.high_gct_right += self.get_gct_from_steps(rf_steps, accumulated_grf_LF, "Right",
                                                                                active_block, n, session_position,
                                                                                session_time_start_object)
                            intensity_bands.high_average_accel_lf += self.get_avg_from_steps(lf_steps, "total_accel_avg", accumulated_grf_LF, "Left",
                                                                               active_block, n, session_position,
                                                                               session_time_start_object)
                            intensity_bands.high_average_accel_rf += self.get_avg_from_steps(rf_steps, "total_accel_avg", accumulated_grf_LF, "Right",
                                                                                active_block, n, session_position,
                                                                                session_time_start_object)
                            intensity_bands.high_average_GRF_lf += self.get_avg_from_steps(lf_steps, "total_grf_avg", accumulated_grf_LF, "Left",
                                                                               active_block, n, session_position,
                                                                               session_time_start_object)
                            intensity_bands.high_average_GRF_rf += self.get_avg_from_steps(rf_steps, "total_grf_avg", accumulated_grf_LF, "Right",
                                                                                active_block, n, session_position,
                                                                                session_time_start_object)
